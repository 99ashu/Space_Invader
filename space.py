...
backgroundImage = pygame.image.load("assets/bg.jpg")
...
class Game():
    ...
    def __init__(self, player, alienGroup, playerBulletGroup, alienBulletGroup):
        ...
        self.newRoundSound = pygame.mixer.Sound("assets/new_round.wav")
        self.newRoundSound.set_volume(0.2)
        self.breachSound = pygame.mixer.Sound("assets/breach.wav")
        self.breachSound.set_volume(0.3)
        self.alienHitSound = pygame.mixer.Sound("assets/alien_hit.wav")
        self.alienHitSound.set_volume(0.3)
        self.playerHitSound = pygame.mixer.Sound("assets/player_hit.wav")
        self.playerHitSound.set_volume(0.2)

        self.font = pygame.font.Font("assets/Facon.ttf", 50)
...
class Player(pygame.sprite.Sprite):
    def __init__(self, bulletGroup):
        ...
        self.shootSound = pygame.mixer.Sound("assets/player_fire.wav")
...
class Alien(pygame.sprite.Sprite):
    def __init__(self, x, y, velocity, bulletGroup):
        ...
        self.shootSound = pygame.mixer.Sound("assets/alien_fire.wav")
        self.shootSound.set_volume(0.2)
